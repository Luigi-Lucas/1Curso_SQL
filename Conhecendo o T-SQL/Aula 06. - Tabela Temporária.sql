...
-- Desafio 2: escrevendo a sequência de FIBONACCI em uma tabela
...
BEGIN
   ...
   INSERT INTO @TABELA VALUES(TRIM(STR(@CONTADOR_SEQUENCIA,10,0)), TRIM(STR(@NUMERO_ATUAL, 10,0)))
